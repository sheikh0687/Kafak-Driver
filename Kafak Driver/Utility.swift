...
//    }
    ...
    class func noDataFoundMessage(_ message: String, tableViewOt: UITableView) {
        ...
        messageLabel.font = R.font.cairoBold(size: 16)   // bold, like screenshot
        ...
        NSLayoutConstraint.activate([
            messageLabel.centerXAnchor.constraint(equalTo: view.centerXAnchor),
            messageLabel.topAnchor.constraint(equalTo: view.topAnchor, constant: 60), // 👈 change to 40 if you prefer
            messageLabel.leadingAnchor.constraint(equalTo: view.leadingAnchor, constant: 20),
            messageLabel.trailingAnchor.constraint(equalTo: view.trailingAnchor, constant: -20)
        ])
    ...
    class func noDataFound(_ title: String, _ message: String, tableViewOt: UITableView, parentViewController parentVC: UIViewController, appendImg: String?) {
        ...
        Utility.setImageWithSDWebImage(appendImg!, imageView)
        
        // Title Label
        let label = UILabel()
        label.translatesAutoresizingMaskIntoConstraints = false
        label.font = R.font.cairoRegular(size: 12)
        label.text = title
        ...
        label2.font = R.font.cairoRegular(size: 12)
        label2.text = message
    ...
    class func noDataFoundImage(_ title: String, _ message: String, tableViewOt: UITableView, parentViewController parentVC: UIViewController, appendImg: UIImage?) {
