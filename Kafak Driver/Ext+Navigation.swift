...
extension UIViewController {
    ...
    public func addLeftBarButtonWithImage(_ buttonImage: String, _ menu: String) {
        let leftButton: UIBarButtonItem = UIBarButtonItem(image: L102Language.currentAppleLanguage() == "en" ? R.image.black_back() : R.image.rightBack(), style: UIBarButtonItem.Style.plain, target: self, action: #selector(self.leftClick))
        navigationItem.leftBarButtonItem = leftButton
    }
