...
struct Api_Profile : Codable {
    let result : Res_Profile?
    let message : String?
    let status : String?
    ...
    init(from decoder: Decoder) throws {
        ...
        result = try values.decodeIfPresent(Res_Profile.self, forKey: .result)
        message = try values.decodeIfPresent(String.self, forKey: .message)
        status = try values.decodeIfPresent(String.self, forKey: .status)
    }
}

struct Res_Profile : Codable {
    let id : String?
    ...
    let sub_service_name_ar : String?
    let sub_service_name_ur : String?
    let sub_service_image : String?
    let distance_range : String?
    ...
    let booking_notifi_count : String?
    ...
    enum CodingKeys: String, CodingKey {
        ...
        case sub_service_name_ar = "sub_service_name_ar"
        case sub_service_name_ur = "sub_service_name_ur"
        case sub_service_image = "sub_service_image"
        case distance_range = "distance_range"
        ...
        case booking_notifi_count = "booking_notifi_count"
    ...
    init(from decoder: Decoder) throws {
        ...
        sub_service_name_ar = try values.decodeIfPresent(String.self, forKey: .sub_service_name_ar)
        sub_service_name_ur = try values.decodeIfPresent(String.self, forKey: .sub_service_name_ur)
        ...
        booking_notifi_count = try values.decodeIfPresent(String.self, forKey: .booking_notifi_count)
        ...
        sub_service_image = try values.decodeIfPresent(String.self, forKey: .sub_service_image)
        distance_range = try values.decodeIfPresent(String.self, forKey: .distance_range)
    }
}
