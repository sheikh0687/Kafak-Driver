...
struct Api_DriverOrders : Codable {
    let result : [Res_DriverOrders]?
    let message : String?
    let status : String?
    ...
    init(from decoder: Decoder) throws {
        ...
        result = try values.decodeIfPresent([Res_DriverOrders].self, forKey: .result)
        message = try values.decodeIfPresent(String.self, forKey: .message)
        status = try values.decodeIfPresent(String.self, forKey: .status)
    }
}

struct Res_DriverOrders : Codable {
    let id : String?
    let user_id : String?
...
//    let driver_details : Driver_details?
    ...
    enum CodingKeys: String, CodingKey {
        ...
        case place_bid_id = "place_bid_id"
...
//        case driver_details = "driver_details"
    ...
    init(from decoder: Decoder) throws {
        ...
        place_bid_id = try values.decodeIfPresent(String.self, forKey: .place_bid_id)
