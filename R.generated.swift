...
struct R: Rswift.Validatable {
  ...
  /// This `R.image` struct is generated, and contains static references to 169 images.
  struct image {
    /// Image `Home24`.
...
struct _R: Rswift.Validatable {
  ...
  struct storyboard: Rswift.Validatable {
    ...
    struct main: Rswift.StoryboardResourceWithInitialControllerType, Rswift.Validatable {
      ...
      let driverTabBarVC = StoryboardViewControllerResource<DriverTabBarVC>(identifier: "DriverTabBarVC")
      ...
      func driverTabBarVC(_: Void = ()) -> DriverTabBarVC? {
        return UIKit.UIStoryboard(resource: self).instantiateViewController(withResource: driverTabBarVC)
      }
      ...
      static func validate() throws {
        ...
        if UIKit.UIImage(named: "Notify24", in: R.hostingBundle, compatibleWith: nil) == nil { throw Rswift.ValidationError(description: "[R.swift] Image named 'Notify24' is used in storyboard 'Main', but couldn't be loaded.") }
        ...
        if UIKit.UIImage(named: "chatnew12", in: R.hostingBundle, compatibleWith: nil) == nil { throw Rswift.ValidationError(description: "[R.swift] Image named 'chatnew12' is used in storyboard 'Main', but couldn't be loaded.") }
        ...
        if _R.storyboard.main().driverTabBarVC() == nil { throw Rswift.ValidationError(description:"[R.swift] ViewController with identifier 'driverTabBarVC' could not be loaded from storyboard 'Main' as 'DriverTabBarVC'.") }
